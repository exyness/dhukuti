...
export const circleMembers = [
  {
    ...
    reputation: 740,
    collateral: "0.75 SOL",
    nextPayout: "Round 01 paid",
    summary: "Host account. Round settled and reputation escrow remains clean.",
    vouch: "2 active vouches",
  },
  {
    handle: "6dH9...qK2m",
    state: "Paid",
    ...
    reputation: 622,
    collateral: "0.75 SOL",
    nextPayout: "Round 02 paid",
    summary: "Accepted the early payout discount and completed contribution settlement.",
    vouch: "1 active vouch",
  },
  {
    handle: "9aV2...Mnt7",
    state: "Pending",
    ...
    collateral: "0.75 SOL",
    nextPayout: "Round 04",
    summary: "Your contribution is queued for this round. Submit before the timer closes.",
    vouch: "Self collateral",
  },
  {
    handle: "Hh3R...92Ls",
    state: "Paid",
    ...
    collateral: "0.75 SOL",
    nextPayout: "Round 05",
    summary: "On-time member with enough reputation to receive without extra vouch stake.",
    vouch: "No vouch needed",
  },
  {
    handle: "4pQn...Yw81",
    state: "Pending",
    ...
    collateral: "0.75 SOL",
    nextPayout: "Round 06",
    summary: "Pending contribution. Host can nudge before the default vote window opens.",
    vouch: "1 active vouch",
  },
  {
    handle: "F3nm...7xVd",
    ...
    reputation: 96,
    collateral: "0.75 SOL",
    nextPayout: "Round 03 disputed",
    summary: "Missed deadline. Default vote can slash collateral into insurance.",
    vouch: "Slashable",
  },
] as const;
